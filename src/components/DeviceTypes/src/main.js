...
const DeviceTypes = function (options, callback) {
  ...
  return new Promise((resolve, reject) => { // eslint-disable-line
    currentMsg = {
      options: Object.assign({}, defaults, DeviceTypes.defaults, options),
      callback: callback,
      resolve: resolve,
      reject: reject
    }
...
// 设置默认配置
DeviceTypes.setDefaults = defaults => {
  DeviceTypes.defaults = defaults
}

// 显示弹框
DeviceTypes.show = (title, options) => {
  ...
  return DeviceTypes(Object.assign({
    title: title
  }, options))
}
// 手动关闭弹框
